...
3. Op regel 14 staan `<p><em>...</em></p>` met daarin de _beschrijving_ van Jane. Pas dit aan naar jouw eigen tekst.
...
9. Klik in het linkermenu op _Pages_.
10. Selecteer bij _Brance_ de **Main branch** en klik op Save:
